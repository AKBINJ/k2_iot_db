...
/*
	...
	cf) 전체 테이블의 컬럼 순서 & 개수와 차이가 나느 경우 반드시 원하고자하는 열 이름 나열
*/
...
create table `example02` (
	# 컬럼명 테이터타입 [primary key] [auto_increment] / 옵션 순서 상관 없음
...
# cf) Sage Update Mode 설정 위치 (MySQL Workbench 기준)
...
SET SQL_SAFE_UPDATES=0; # 0: 모드 사용
