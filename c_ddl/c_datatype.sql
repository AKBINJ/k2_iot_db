...
/*
	...
	1) char(개수)
    : 고정 길이 문자열, 1 ~ 255 바이트
    - 길이가 항상 일정하기 때문에 검색 속도가 빠름alter
...
values ('Lapto Samsung Book 3 Pro', '전자제품', '삼성 갤럭시 북3 노트북 프로입니다. 아주 좋아요', 'example');
...
create table product (
    ...
    price1 float(7, 2),		-- float, double 형태로만 사용 권장
    -- price1 float (권장)
    price2 double(10, 4),
    -- price2 double (권장)
...
insert into product
values (12345.67, 1234556.7890, 99999999999.99);
